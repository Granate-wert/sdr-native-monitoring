...
_CATALOG: Mapping[str, TranslationEntry] = MappingProxyType(
    {
        ...
        "analyzer.preview.summary": MappingProxyType({UiLocale.RU: "План: {segments} сегм. · {bins} точек · шаг {spacing} Hz · {average} FFT/спектр · данные ≤ {memory} MiB", UiLocale.EN: "Plan: {segments} segments · {bins} points · spacing {spacing} Hz · {average} FFT/spectrum · data ≤ {memory} MiB"}),
